...
// (DIPERBARUI) Menambahkan detail teknis (kategori, root, android, fitur).
...
export const mods = [
  {
    ...
    category: 'Game Mod', // <-- Kategori baru untuk filter
    requiresRoot: false,
    minAndroid: null,
    features: [
      'HD Sky Textures',
    ...
    gallery: [
      'https://placehold.co/600x300/e2ece9/333?text=Screenshot+1',
      'https://placehold.co/600x300/fddde6/333?text=Screenshot+2',
    ],
    downloadUrl: '#',
  ...
  },
  {
    ...
    game: 'Spotify', // Game bisa juga nama aplikasi
    version: '8.9.2',
    ...
    category: 'App Mod', // <-- Kategori baru untuk filter
    requiresRoot: true,
    minAndroid: '7.0+',
    features: [
      'Ad-Free Listening',
  ...
  },
  {
    ...
    category: 'Script', // <-- Kategori baru untuk filter
    requiresRoot: true,
    minAndroid: '5.0+',
    features: [
